...
{
  //val textureCoords = arrayOf<Float>(0.0f, 0.01f, 0.01f, 0.01f, 0.01f, 0.0f, 0.0f, 0.0f)
  val textureCoords = arrayOf<Float>(0.0f, 1.0f, 1.0f, 1.0f, 1.0f, 0.0f, 0.0f, 0.0f)
  //val textureCoords = arrayOf<Float>(0.0f, 1.0f, 0.1f, 1.0f, 0.1f, 0.0f, 0.0f, 0.0f)
  ...
  fun changeColor(d: Float)
  {
    for(i : Int in 0 until textureCoords.size){
      if(i % 2 == 0)
        textureCoords[i] += d
    }
    gl.bindBuffer(GL.ARRAY_BUFFER, vertexTexCoordBuffer)
