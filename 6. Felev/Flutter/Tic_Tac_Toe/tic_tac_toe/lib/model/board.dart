...
class Board{
  ...
  Player evaluate(){
    ...
    if(this.getPlayer(Coord(0, 0)) != Logic.nobody && this.getPlayer(Coord(2, 0)) == this.getPlayer(Coord(1, 1)) && this.getPlayer(Coord(2, 0)) == this.getPlayer(Coord(0, 2)))
      return this.getPlayer(Coord(2, 0));

    for(int i = 0; i < 3; ++i)
    {
      if(this.getPlayer(Coord(i, 0)) != Logic.nobody && this.getPlayer(Coord(i, 0)) == this.getPlayer(Coord(i, 1)) && this.getPlayer(Coord(i, 0)) == this.getPlayer(Coord(i, 2)))
        return this.getPlayer(Coord(0, 0));

      if(this.getPlayer(Coord(0, i)) != Logic.nobody && this.getPlayer(Coord(0, i)) == this.getPlayer(Coord(1, i)) && this.getPlayer(Coord(0, i)) == this.getPlayer(Coord(2, i)))
        return this.getPlayer(Coord(2, 0));
    }
