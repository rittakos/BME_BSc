...
START_NAMESPACE
	...
	void * traced_malloc(std::size_t size, const char *size_txt, int line, const char * file);

	#undef calloc
	#define calloc(count,size) TRACEC(traced_calloc)(count, size, #count","#size,__LINE__,__FILE__)
	void * traced_calloc(std::size_t count, std::size_t size, const char *size_txt, int line, const char * file);
	...
	void * traced_realloc(void * old, std::size_t size, const char *size_txt, int line, const char * file);

	void mem_dump(void const *mem, std::size_t size, FILE* fp);
...
void * operator new(std::size_t size, int line, const char * file) THROW_BADALLOC;
void * operator new[](std::size_t size, int line, const char * file) THROW_BADALLOC;
void * operator new(std::size_t size) THROW_BADALLOC;
void * operator new[](std::size_t size) THROW_BADALLOC;
