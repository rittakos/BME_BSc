...
class Vektor {
    ...
    std::size_t nElements;           // vektor elmeinek száma
    static std::size_t defSize;      // vektor alapértelmezett mérete
...
public:
    ...
    Vektor(std::size_t size = defSize, double value = defValue) :nElements(size)
    {
    ...
    static void setDefSize(std::size_t size)
    {
        defSize = size;
    }
    ...
    static void setDefValue(double value)
    {
        defValue = value;
    }
